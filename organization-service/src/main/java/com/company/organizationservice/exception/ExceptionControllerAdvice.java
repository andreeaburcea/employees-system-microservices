...
public class ExceptionControllerAdvice {
    ...
    public ResponseEntity<ErrorInfo> departmentExceptionHandler(OrganizationException organizationException) {
        ErrorInfo errorInfo = new ErrorInfo();
        errorInfo.setErrorMesssage(environment.getProperty(organizationException.getMessage()));
        errorInfo.setTimestamp(LocalDateTime.now());
